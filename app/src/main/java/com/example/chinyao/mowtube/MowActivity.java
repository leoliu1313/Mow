...
public class MowActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CoordinatorLayout == 2) {
            ...
            CollapsingToolbarLayout collapsingToolbar =
                    (CollapsingToolbarLayout) findViewById(com.example.chinyao.mowtube.R.id.collapsing_toolbar);
            collapsingToolbar.setTitle(getString(com.example.chinyao.mowtube.R.string.app_name));

            Typeface tf;
            // tf = Typeface.createFromAsset(MowActivity.this.getAssets(), "fonts/FrutigerLTStd-Light.otf");
            ...
            imageView = (ImageView) findViewById(com.example.chinyao.mowtube.R.id.backdrop);
            glideRandomDrawable();
        }
        else if (CoordinatorLayout == 1) {
            setContentView(com.example.chinyao.mowtube.R.layout.activity_main);
        }

        // need to use findViewById to get object from layout
        itemsListView = (ListView) findViewById(com.example.chinyao.mowtube.R.id.lvItems);
        newItemEditText = (EditText) findViewById(com.example.chinyao.mowtube.R.id.etNewItem);
        ...
        if (CoordinatorLayout == 1) {
            ...
            Snackbar.make(findViewById(com.example.chinyao.mowtube.R.id.fab),
                          "Version 1607181526",
    ...
    private void setListener() {
        ...
        if (CoordinatorLayout == 2) {
            FloatingActionButton fab = (FloatingActionButton) findViewById(com.example.chinyao.mowtube.R.id.fab);
            fab.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    MaterialDialog theDialog =
                            new MaterialDialog.Builder(MowActivity.this)
                                    .title(com.example.chinyao.mowtube.R.string.add_button)
                                    .inputType(InputType.TYPE_CLASS_TEXT)
                                    .positiveText(getString(com.example.chinyao.mowtube.R.string.save_button))
                                    .inputRangeRes(1, 200, com.example.chinyao.mowtube.R.color.colorAccentLight)
        ...
        if (CustomAdapter == 3) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(com.example.chinyao.mowtube.R.id.container, new SwipeableExampleFragment(), FRAGMENT_LIST_VIEW)
                    .commit();
        }
    }
    ...
    void editItem(View item, int position) {
        if (UIMode == 1) {
            Intent data = new Intent(MowActivity.this, EditItemActivity.class);
    ...
    boolean removeItem(int position) {
        if (UIMode == 1 || UIMode == 2) {
            ...
            new MaterialDialog.Builder(MowActivity.this)
                    .title(getString(com.example.chinyao.mowtube.R.string.remove_item_title))
                    .content(theTodoModel.content)
                    .positiveText(getString(com.example.chinyao.mowtube.R.string.remove_item_pos))
                    .negativeText(getString(com.example.chinyao.mowtube.R.string.remove_item_neg))
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int offset) {
        /*
        Log.d("MowActivity", "start");
        Log.d("MowActivity", Integer.toString(appBarLayout.getTotalScrollRange()));
        Log.d("MowActivity", Integer.toString(offset));
        */
        if (handler == null) {
            handler = new Handler();
        }
    ...
    private void showMaterialDialog(int position){
        ...
        new MaterialDialog.Builder(this)
                .title(getString(com.example.chinyao.mowtube.R.string.edit_item_title))
                        ...
                        if (which == 0) {
                            ...
                            CalendarDatePickerDialogFragment cdp =
                                    new CalendarDatePickerDialogFragment()
                                            .setThemeCustom(com.example.chinyao.mowtube.R.style.DateTheme)
                                            .setOnDateSetListener(MowActivity.this)
                            ...
                            new MaterialDialog.Builder(MowActivity.this)
                                    .items(com.example.chinyao.mowtube.R.array.priority)
    ...
    private ArrayList<MaterialSimpleListItem> createDataArrayList(TodoModel theTodoModel) {
        ...
        dataArrayList.add(new MaterialSimpleListItem.Builder(MowActivity.this)
                .content(theTodoModel.content)
                .icon(com.example.chinyao.mowtube.R.drawable.ic_bookmark_border_black_48dp)
                .backgroundColor(ContextCompat.getColor(MowActivity.this, com.example.chinyao.mowtube.R.color.colorPrimaryLight))
                .build());
        dataArrayList.add(new MaterialSimpleListItem.Builder(this)
                .content(theTodoModel.date)
                .icon(com.example.chinyao.mowtube.R.drawable.ic_date_range_black_48dp)
                .backgroundColor(ContextCompat.getColor(MowActivity.this, com.example.chinyao.mowtube.R.color.colorDateLight))
                .build());
        dataArrayList.add(new MaterialSimpleListItem.Builder(this)
                .content(theTodoModel.priority)
                .icon(com.example.chinyao.mowtube.R.drawable.ic_priority_high_black_48dp)
                .backgroundColor(ContextCompat.getColor(MowActivity.this, com.example.chinyao.mowtube.R.color.colorAccentLight))
                .build());
    ...
    public static int getRandomDrawable() {
        ...
        switch (currentDrawable) {
            default:
            case 0:
                return com.example.chinyao.mowtube.R.drawable.coffee_21;
            case 1:
                return com.example.chinyao.mowtube.R.drawable.coffee_22;
            case 2:
                return com.example.chinyao.mowtube.R.drawable.coffee_23;
        }
    }
    ...
    public void onItemRemoved(int position) {
        Snackbar snackbar = Snackbar.make(
                findViewById(com.example.chinyao.mowtube.R.id.container),
                com.example.chinyao.mowtube.R.string.snack_bar_text_item_removed,
                Snackbar.LENGTH_LONG);

        snackbar.setAction(com.example.chinyao.mowtube.R.string.snack_bar_action_undo, new View.OnClickListener() {
            @Override
        ...
        snackbar.setActionTextColor(ContextCompat.getColor(this, com.example.chinyao.mowtube.R.color.snackbar_action_color_done));
        snackbar.show();
        writeItems();
    }
