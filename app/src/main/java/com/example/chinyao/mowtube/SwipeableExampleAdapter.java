...
class SwipeableExampleAdapter
    ...
    public static class MyViewHolder extends AbstractSwipeableItemViewHolder {
        ...
        public MyViewHolder(View v) {
            super(v);
            mContainer = (RelativeLayout) v.findViewById(com.example.chinyao.mowtube.R.id.container);
            mContent = (TextView) v.findViewById(com.example.chinyao.mowtube.R.id.itemContent);
            mDate = (TextView) v.findViewById(com.example.chinyao.mowtube.R.id.itemDate);
            mPriority = (TextView) v.findViewById(com.example.chinyao.mowtube.R.id.itemPriority);
        }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(com.example.chinyao.mowtube.R.layout.list_item, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (item.priority.equals("High Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), com.example.chinyao.mowtube.R.color.colorAccent));
        }
        else if (item.priority.equals("Mid Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), com.example.chinyao.mowtube.R.color.colorPrimaryDark));
        }
        else if (item.priority.equals("Low Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), com.example.chinyao.mowtube.R.color.colorPrimary));
        }
        ...
        if ((swipeState & Swipeable.STATE_FLAG_IS_UPDATED) != 0) {
            int bgResId = com.example.chinyao.mowtube.R.drawable.bg_item_normal_state;
    ...
    public void onSetSwipeBackground(MyViewHolder holder, int position, int type) {
        ...
        switch (type) {
            case Swipeable.DRAWABLE_SWIPE_NEUTRAL_BACKGROUND:
                bgRes = com.example.chinyao.mowtube.R.drawable.bg_swipe_item_neutral;
                break;
            case Swipeable.DRAWABLE_SWIPE_LEFT_BACKGROUND:
                bgRes = com.example.chinyao.mowtube.R.drawable.bg_swipe_item_left;
                break;
            case Swipeable.DRAWABLE_SWIPE_RIGHT_BACKGROUND:
                bgRes = com.example.chinyao.mowtube.R.drawable.bg_swipe_item_right;
                break;
        }
