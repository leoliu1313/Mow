...
public class SwipeableExampleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.example.chinyao.mowtube.R.layout.fragment_recycler_list_view, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) getView().findViewById(com.example.chinyao.mowtube.R.id.recycler_view);
        ...
        if (supportsViewElevation()) {
            ...
            mRecyclerView.addItemDecoration(new ItemShadowDecorator((NinePatchDrawable) ContextCompat.getDrawable(getContext(), com.example.chinyao.mowtube.R.drawable.material_shadow_z1)));
        }
        mRecyclerView.addItemDecoration(new SimpleListDividerDecorator(ContextCompat.getDrawable(getContext(), com.example.chinyao.mowtube.R.drawable.list_divider_h), true));
...
//        mRecyclerViewSwipeManager.setReturnToDefaultPositionAnimationDuration(2000);
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (position != RecyclerView.NO_POSITION) {
            ((MowActivity) getActivity()).onItemClicked(position);
        }
    }
    ...
    private boolean onItemViewLongClick(View v, boolean pinned) {
        int position = mRecyclerView.getChildAdapterPosition(v);
        if (position != RecyclerView.NO_POSITION) {
            return ((MowActivity) getActivity()).onItemLongClicked(position);
        }
        else {
            return false;
        }
    ...
    public ExampleDataProvider getDataProvider() {
        return ((MowActivity) getActivity()).getDataProvider();
    }
