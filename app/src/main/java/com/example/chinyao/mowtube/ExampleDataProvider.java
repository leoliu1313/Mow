...
public class ExampleDataProvider extends AbstractDataProvider {
    ...
    public void addItems(ArrayList<com.example.chinyao.mowtube.TodoModel> itemsArrayList) {
        this.mData = itemsArrayList;
    }

    public void addItem(com.example.chinyao.mowtube.TodoModel theTodoModel) {
