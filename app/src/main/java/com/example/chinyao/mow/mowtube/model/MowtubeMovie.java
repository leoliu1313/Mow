package com.example.chinyao.mow.mowtube.model;
...
public class MowtubeMovie {
    ...
    public static ArrayList<MowtubeMovie> fromArrayList(ArrayList<String> input) {
        ...
        for (int i=0; i < input.size(); i++) {
            ...
            movie.poster_path = "http://image.tmdb.org/t/p/w500/vsjBeMPZtyB7yNsYY56XYxifaQZ.jpg";
            movie.adult = false;
            ...
            movie.backdrop_path = "http://image.tmdb.org/t/p/w500/vsjBeMPZtyB7yNsYY56XYxifaQZ.jpg";
