package com.example.chinyao.mow.mow.list;
...
public class ItemAdapter extends ArrayAdapter<TodoModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.mow_list_item, parent, false);
        ...
        if (item.priority.equals("High Priority")) {
            viewHolder.priority.setTextColor(
                    ContextCompat.getColor(getContext(), R.color.mowColorAccent));
        }
        else if (item.priority.equals("Mid Priority")) {
            viewHolder.priority.setTextColor(
                    ContextCompat.getColor(getContext(), R.color.mowColorPrimaryDark));
        }
        else if (item.priority.equals("Low Priority")) {
            viewHolder.priority.setTextColor(
                    ContextCompat.getColor(getContext(), R.color.mowColorPrimary));
        }
