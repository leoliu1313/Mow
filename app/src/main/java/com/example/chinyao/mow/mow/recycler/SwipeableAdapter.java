...
class SwipeableAdapter
        extends RecyclerView.Adapter<SwipeableAdapter.MyViewHolder>
        implements SwipeableItemAdapter<SwipeableAdapter.MyViewHolder> {
    ...
    public SwipeableAdapter(DataProvider dataProvider) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (item.priority.equals("High Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), R.color.mowColorAccent));
        }
        else if (item.priority.equals("Mid Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), R.color.mowColorPrimaryDark));
        }
        else if (item.priority.equals("Low Priority")) {
            holder.mPriority.setTextColor(
                    ContextCompat.getColor(holder.mPriority.getContext(), R.color.mowColorPrimary));
        }
    ...
    private static class SwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        private SwipeableAdapter mAdapter;
        private final int mPosition;
        private boolean mSetPinned;

        SwipeLeftResultAction(SwipeableAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
        ...
        protected void onPerformAction() {
            ...
            DataProviderAbstract.Data item = mAdapter.mProvider.getItem(mPosition);
    ...
    private static class SwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        SwipeRightResultAction(SwipeableAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
    ...
    private static class UnpinResultAction extends SwipeResultActionDefault {
        ...
        UnpinResultAction(SwipeableAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
