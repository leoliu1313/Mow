...
import com.example.chinyao.mow.mow.list.ItemAdapter;
import com.example.chinyao.mow.mow.model.DataProvider;
import com.example.chinyao.mow.mow.model.DataProviderAbstract;
import com.example.chinyao.mow.mow.model.DatabaseHelper;
import com.example.chinyao.mow.mow.model.SettingModel;
import com.example.chinyao.mow.mow.model.TodoModel;
import com.example.chinyao.mow.mow.recycler.DataProviderFragment;
import com.example.chinyao.mow.mow.recycler.ItemPinnedMessageDialogFragment;
import com.example.chinyao.mow.mow.recycler.SwipeableFragment;
...
public class MowActivity extends AppCompatActivity
    ...
    private SwipeableFragment theSwipeableFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CoordinatorLayout == 2) {
            ...
            setContentView(R.layout.mow_activity_detail);
            final Toolbar toolbar = (Toolbar) findViewById(R.id.m_toolbar);
            setSupportActionBar(toolbar);
            // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            CollapsingToolbarLayout collapsingToolbar =
                    (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
            collapsingToolbar.setTitle(getString(R.string.mow_app_name));
            ...
            setContentView(R.layout.mow_activity_list_view);
        }
    ...
    private void setListener() {
        ...
        if (CoordinatorLayout == 2) {
                ...
                public void onClick(View view) {
                    MaterialDialog theDialog =
                            new MaterialDialog.Builder(MowActivity.this)
                                    ...
                                    .inputRangeRes(1, 200, R.color.mowColorAccentLight)
            ...
            final AppBarLayout appbar =
                    (AppBarLayout) findViewById(R.id.m_app_bar_layout);
            appbar.addOnOffsetChangedListener(this);
        }

        if (CustomAdapter == 3) {
            getSupportFragmentManager().beginTransaction()
                    .add(new DataProviderFragment().addItems(itemsArrayList), FRAGMENT_TAG_DATA_PROVIDER)
                    .commit();
            theSwipeableFragment = new SwipeableFragment();
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new SwipeableFragment(), FRAGMENT_LIST_VIEW)
                    .commit();
        }
    }
                        ...
                        public void onClick(@NonNull MaterialDialog dialog,
                            ...
                            if (which.equals(DialogAction.POSITIVE)) {
                                ...
                                if (CustomAdapter == 3) {
                                    ...
                                    ((SwipeableFragment) fragment).notifyItemRemoved(position_tag);
                                }
    ...
    private ArrayList<MaterialSimpleListItem> createDataArrayList(TodoModel theTodoModel) {
        ...
        dataArrayList.add(new MaterialSimpleListItem.Builder(MowActivity.this)
                ...
                .backgroundColor(ContextCompat.getColor(MowActivity.this, R.color.mowColorPrimaryLight))
                .build());
        dataArrayList.add(new MaterialSimpleListItem.Builder(this)
                ...
                .backgroundColor(ContextCompat.getColor(MowActivity.this, R.color.mowColorDateLight))
                .build());
        dataArrayList.add(new MaterialSimpleListItem.Builder(this)
                .content(theTodoModel.priority)
                .icon(R.drawable.ic_priority_high_black_48dp)
                .backgroundColor(ContextCompat.getColor(MowActivity.this, R.color.mowColorAccentLight))
                .build());
    ...
    private void notifyItemChanged(int position) {
        if (CustomAdapter == 3) {
            final Fragment fragment = getSupportFragmentManager().findFragmentByTag(FRAGMENT_LIST_VIEW);
            ((SwipeableFragment) fragment).notifyItemChanged(position);
        }
    }
    ...
    private void onItemUndoActionClicked() {
        ...
        if (position >= 0) {
            final Fragment fragment = getSupportFragmentManager().findFragmentByTag(FRAGMENT_LIST_VIEW);
            ((SwipeableFragment) fragment).notifyItemInserted(position);
        }
    }
    ...
    public void onItemClicked(int position) {
        DataProviderAbstract.Data data = getDataProvider().getItem(position);
